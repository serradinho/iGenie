...
if ( !class_exists( 'iGenie_Shortcodes_API' ) ) {
	...
	class iGenie_Shortcodes_API {
		...
		public static function GetInstance() {
			if ( !isset( self::$instance ) ) {
				self::$instance = new iGenie_Shortcodes_API();
			}
	...
	// end iGenie_Shortcodes_API class
	...
	class Add_Shortcode {
		...
		public function add_att( $att ) {
			$shortcode_data = get_option( iGenie_Shortcodes_API::$shortcode_options_key );
		...
		private function save_shortcode_data( $shortcode_data = null ) {
			...
			update_option( iGenie_Shortcodes_API::$shortcode_options_key, $shortcode_data );
			return get_option( iGenie_Shortcodes_API::$shortcode_options_key );
		}
		...
		public function add_media_button( $args ) {
			...
			$this->media_button = new iGenie_Shortcodes_Media_Button( $shortcode_name, $title, $icon, $intro, $input_atts );
	...
	class iGenie_Shortcodes_Media_Button {
	...
	// end iGenie_Shortcodes_Media_Button Class
